...
def build_html(vitals, holds, field_notes, handoff, era_num, era_name, haiku_lines, haiku_attr, velocity, generated_at, signal=None, parables=None):
    ...
    <div class="parable-card">
      ...
      <div class="parable-section-count">{total} parable{'s' if total != 1 else ''} in the anthology &nbsp;·&nbsp; <a href="/parables" style="color:#484f58;text-decoration:none;" onmouseover="this.style.color='#bc8cff'" onmouseout="this.style.color='#484f58'">read all →</a></div>
    </div>
    """
...
<body>
  ...
  <div class="footer">
    ...
    <span>generated by dashboard.py · signal via serve.py /api/signal · <a href="/tools" style="color:#484f58;text-decoration:none;" onmouseover="this.style.color='#58a6ff'" onmouseout="this.style.color='#484f58'">toolkit →</a> · <a href="/notes" style="color:#484f58;text-decoration:none;" onmouseover="this.style.color='#58a6ff'" onmouseout="this.style.color='#484f58'">notes →</a> · <a href="/parables" style="color:#484f58;text-decoration:none;" onmouseover="this.style.color='#bc8cff'" onmouseout="this.style.color='#484f58'">parables →</a></span>
  </div>
