...
=== Claude OS Worker v3 ===
Task ID: codex-review-ghostband-hub-flip-2
Profile: medium
Agent: codex
Mode: execution
...
Field guide — fill in REAL values, do NOT copy these descriptions:
  ...
  task_id    → always "codex-review-ghostband-hub-flip-2"
  agent      → always "codex"
...
=== CLAUDE_OS_USAGE ===
{"task_id":"codex-review-ghostband-hub-flip-2","agent":"codex","profile":"medium","duration_seconds":4,"exit_code":1,"finished_at":"2026-06-28T06:09:06Z"}
=== END_CLAUDE_OS_USAGE ===
